...
PLUGINS = ["nautobot_chatops", "nautobot_capacity_metrics", "nautobot_chatops_ansible"]
...
PLUGINS_CONFIG = {
    "nautobot_chatops": {
        ...
        "slack_slash_command_prefix": os.getenv("SLACK_SLASH_COMMAND_PREFIX", "/"),
        "webex_teams_token": os.getenv("WEBEX_TEAMS_ACCESS_TOKEN"),
        "webex_teams_signing_secret": os.getenv("WEBEX_TEAMS_SIGNING_SECRET"),
